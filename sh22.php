...
?>
<div class="header">
 <h1 align="center">QUERY ON FOREST RESOURCE</h1>	
 </div>
<?php
$conn = "(DESCRIPTION=(ADDRESS_LIST = (ADDRESS = (PROTOCOL = TCP)(HOST= localhost)(PORT = 1521)))(CONNECT_DATA=(SID=xe)))" ; 
   $db=oci_connect("anik4010", "1234", $conn);
$strSQL = "SELECT F_REGION  , F_area_Sq_km , F_Resource_type,
	Animal_name  FROM FOREST JOIN ANIMALS USING (Forest_ext_id)  
	ORDER BY F_REGION ASC";
...
<th width="97"> <div align="center">EXISTING ANIIMALS</div></th>
</tr>
<?php
