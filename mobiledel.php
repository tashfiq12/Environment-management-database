...
?>
<div class="header">
       <h1 align="center">MOBILE COURT RECORD DELETE</h1>
...
<form name="frmMain" action="mobiledelrec.php" method="post" OnSubmit="return onDelete();">
<?php
...
$strSQL = "SELECT * FROM MOBILE_COURT ";
...
<table align="center" width="600" border="1">
  <tr>
    ...
    <th width="99"> <div align="center">PUNISHMENT CODE</div></th>
...
?>
  <tr>
    ...
    <th><div align="center"><?php echo $objResult["PUNISHMENT_CODE"];?></th>
