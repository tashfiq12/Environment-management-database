...
?>
<div class="header">
 <h1 align="center">CHANGED EMPLOYEE ID FORMAT</h1>	
 </div>
<?php
$conn = "(DESCRIPTION=(ADDRESS_LIST = (ADDRESS = (PROTOCOL = TCP)(HOST= localhost)(PORT = 1521)))(CONNECT_DATA=(SID=xe)))" ; 
   $db=oci_connect("anik4010", "1234", $conn);
$strSQL = "SELECT EMP_ID,FIRST_NAME, REPLACE(SUBSTR(EMP_ID,1,9), 'E0', 'EM') FROM EMPLOYEE";
...
<th width="98"> <div align="center">OUTPUT</div></th>
</tr>
<?php
