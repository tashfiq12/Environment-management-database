...
<title>RESEARCH DEPARTMENT INSERT</title>
</head>
<body>
<?php
...
<div style="text-align:center" class="header">
       <h1>RESEARCH DEPARTMENT INSERT</h1>
  	
  </div>
<form action="RESEARCH_DEPT_SAVE.php" name="frmAdd" method="post">

<table align="center" width="600" border="1">
<!--<table align="center" width="600" style="text-align:center;border-collapse:collapse;background-color:black;">-->
  <tr>
    <th width="120"> <div align="center">ITEM_NO</div></th>
    <th width="120"> <div align="center">ITEM_NAME </div></th>
	<th width="120"> <div align="center">INCHARGE_ID  </div></th>
    <th width="120"> <div align="center">DEPT_CODE</div></th>
  </tr>
  <tr>
    <td><div align="center"><input type="text" name="itno" size="10"></div></td>
    <td><div align="center"><input type="text" name="itmname" size="10"></td>
	<td><div align="center"><input type="text" name="icid" size="10"></div></td>
