...
<title>POLLUTION CHECKER  INSERT</title>
</head>
<body>
<?php
...
<div style="text-align:center" class="header">
       <h1>POLLUTION LEVEL CHECKER INSERT</h1>
  	
  </div>
<form action="pollevelinsave.php" name="frmAdd" method="post">
...
<!--<table align="center" width="600" style="text-align:center;border-collapse:collapse;background-color:black;">-->
  <tr>
	...
	<th width="120"> <div align="center">NEW POLLUTION LEVEL</div></th>
  </tr>
  <tr>
    ...
    <td><div align="center"><input type="number" name="pc" size="10"></td>
